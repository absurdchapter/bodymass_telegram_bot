...
PLEASE_ENTER_VALID_POSITIVE_NUMBER = ("Пожалуйста, введите действительное положительное число (ваш вес тела в кг) \n"
...
NOTFAT_OPTIONS = [
    "Ты замечательно выглядишь. Твоё тело заслуживает уважения и любви таким, какое оно есть. Помни, что здоровье и самочувствие гораздо важнее цифр на весах. Ты на правильном пути к гармонии с собой! 🌟",
    "Ой, ты что, сомневаешься в себе? Не волнуйся! Ты красив(а) и силён/сильна, и каждый день ты делаешь шаги к лучшей версии себя. Держись! 💪",
    "Слушай внимательно, дорогой(ая) %USERNAME%! Ты не просто не толстый(ая), ты – <b>изумительно прекрасно созданный образец человеческой красоты и силы!</b>\n\nНе забывай, что путь к идеалу – не только в цифрах на весах, но и в здоровьи, радости и самопринятии. Ты уже сделал(а) огромный шаг, начав следить за своим весом и заботиться о себе.\n\n<b>Продолжай в том же духе, верь в себя и помни, что каждый твой шаг вперёд – это победа!</b>",
